...
public:
	...
	virtual void showGens(ostream& = cout, bool samebirth = false, const string buf = "------ ") const;
	...
	virtual void setCB(const CCHAIN& toset, bool mkcb=true);
	...
	virtual void addBDLink(Cell<C,BT>* toadd, const C& coeff, bool= true, bool= true);
	virtual void addCBLink(Cell<C,BT>* toadd, const C& coeff, bool= true, bool= true);
};
